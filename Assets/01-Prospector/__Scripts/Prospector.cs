...
public class Prospector : MonoBehaviour
{
	...
	void LayoutGame()
	{
		...
		foreach (SlotDef tSD in layout.slotDefs)
		{
			...
			cp.transform.parent = layoutAnchor; // Make its parent layoutAnchor // This replaces the previous parent: deck.deckAnchor, which
	...
	void FloatingScoreHandler(eScoreEvent evt)
	{
		...
		switch (evt)
		{
			...
			case eScoreEvent.gameLoss: // Lost the round // Add fsRun to the Scoreboard score
				if (fsRun != null)
				{
